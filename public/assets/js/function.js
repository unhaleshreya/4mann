(function ($) {
	...
	if ($('.product-detail-slider').length) {
		const product_detail_slider = new Swiper('.product-detail-slider .swiper', {
			slidesPerView : 1,
			speed: 1000,
			spaceBetween: 30,
			loop: true,
	...
	if ($('.our-products-slider').length) {
		const testimonial_company_slider = new Swiper('.our-products-slider .swiper', {
			slidesPerView : 2,
			speed: 2000,
			spaceBetween: 30,
			loop: true,
