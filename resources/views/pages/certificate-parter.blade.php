...
<?php include 'includes/menu.php' ?>
    ...
    <!-- Certifications & Trusted Partners Section Start -->
    <div class="our-testimonial py-5">
        <div class="container">


            <!-- Grid of Company Logos Start -->
            <div class="row g-4">
                ...
                <!-- Add more logos as needed using the same structure -->
            </div>
            <!-- Grid of Company Logos End -->
        </div>
    </div>
    <!-- Certifications & Trusted Partners Section End -->
@endsection
